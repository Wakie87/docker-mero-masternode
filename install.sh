#!/bin/bash
# Original Author: Greerso https://github.com/greerso
# 
#
...
# Project Specific
    PROJECT_NAME="mero"
    PROJECT_GITHUB_REPO="merocoin/mero"
...
declare -A INSTALL_STEPS=(
    ...
    [${PROJECT_NAME}_conf]="On the QT wallet, open the ${PROJECT_NAME}.conf file via the menu Tools->Open Wallet Configuration File.\n\nPaste the lines that will appear on the next screen then save and close the file"
...
msgbox "${INSTALL_STEPS[${PROJECT_NAME}_conf]}"
